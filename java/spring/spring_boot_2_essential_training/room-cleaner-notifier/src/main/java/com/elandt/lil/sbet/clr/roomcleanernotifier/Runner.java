package com.elandt.lil.sbet.clr.roomcleanernotifier;
...
public class Runner implements CommandLineRunner {
    ...
    public Runner(RabbitTemplate rabbitTemplate, ObjectMapper objectMapper, ConfigurableApplicationContext context) {
